        ...
        return (
            <div className='liveDetail'>
                <div className='liveDetail_bg'>
                    ...
                    <div className='liveDetail_subject'>{this.state.object.speakerInfo}</div>
...
class UserInfoCell extends Component {
    ...
    isAddFollow() {
        if (this.props.obj.host_gz_id == '0' && this.props.obj.host_group_gz_id == '0') {
            return <img src={addFollow} alt="" className='liveDetail_addFollowBtn'/>
        }
    }
        ...
        return(
            <div>
                <div className='liveDetail_userInfo'>
                    <img src={this.props.obj.head_img} alt="" className='liveDetail_userIcon'/>
                    <div>
                        <div className='liveDetail_userName'>
                            <div className='liveDetail_user_nameLeft'>主持人</div>
                            <div className='liveDetail_user_nameRight'>{this.props.obj.name}</div>
                        </div>
                        <div className='liveDetail_userComeFrom'>
